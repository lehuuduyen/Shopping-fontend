(function ($) {
    ...
    $(document).ready(function () {
        ...
        $("#cart").hoverIntent({
            sensitivity: 3, interval: 60, over: function () {
                $('.cart-list', this).fadeIn(200);
                $('.cart-btn a.button', this).addClass('hovered');
            }, timeout: 220, out: function () {
                $('.cart-list', this).fadeOut(100);
                $('.cart-btn a.button', this).removeClass('hovered');
            }
        });
        $('ul.menu').superfish({delay: 400, speed: 200, speedOut: 100, autoArrows: true});
        ...
        $(".parallax-banner").pureparallax({overlayBackgroundColor: '#000', overlayOpacity: '0.45', timeout: 200});
        $(".parallax-titlebar").pureparallax({timeout: 100});
        ...
        function skillbarActive() {
            setTimeout(function () {
                $('.skill-bar-value').each(function () {
                    ...
                    $(this).animate({width: $(this).data("origWidth")}, 1200);
                });
        ...
        $(".variables select").each(function () {
            if (!isMobile) {
                var sb = new SelectBox({selectbox: $(this)});
                void(sb);
            }
        });
        ...
        $('.option-set li').click(function (event) {
            ...
            var item = $(".og-grid li"), image = item.find('a.grid-item-image img');
